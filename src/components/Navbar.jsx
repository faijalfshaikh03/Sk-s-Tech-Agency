...
bg-white/50 dark:bg-gray-900/70">
      ...
      <img src={theme === 'dark' ? assets.logo_dark : assets.logo} alt='Logo' className='w-32 sm:2-40' />
      ...
      <div className='flex items-center gap-2 sm:gap-4'>
        ...
        <a href="#contact-us" className='text-sm max-sm:hidden flex items-center gap-2 bg-blue text-white px-6 py-2 rounded-full cursor-pointer bg-primary hover:scale-103 transition-all z-50'>
